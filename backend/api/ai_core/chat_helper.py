...
class ConversationalRetrievalBot:
    ...
    def __init__(self, redis_url="http://127.0.0.1:6379", google_api_key=None, model="gemini-2.0-flash-lite", 
    ...
    def _create_memory(self, session_id):
        ...
        """
        message_history = RedisChatMessageHistory(session_id=session_id, url=self.redis_url)
    ...
    def get_chain_for_user(self, session_id, retriever, language="english"):
        ...
        answer_prompt = ChatPromptTemplate.from_template(self._answer_template(language=language))
...
class ChatbotService:
    ...
    def chat(self, user_id: str, article_id: str, message: str, language: str = "english"):
        """
        ...
        chat_history = chain.memory.chat_memory.messages if hasattr(chain, 'memory') else []
